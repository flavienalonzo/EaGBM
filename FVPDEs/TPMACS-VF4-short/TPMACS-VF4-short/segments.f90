SUBROUTINE   segments
  ...
  If (maillageregulier == 1) then 
     ...
     iseg = 0
     ! num�roter les segments � gauche et � droite 
     DO j = 1, NY
     ...
     END DO
     !!     print*,'iseg = ', iseg
     ! num�roter les segments en bas et en haut
     DO i = 1, NX
  ...
  ELSE 
     ...
     CASE (2)
        ...
        !! on d�duit que les deux sommets du segment sont deux sommets du triangle
        !! on ar�te d�s que on trouve les trois sommets. 
