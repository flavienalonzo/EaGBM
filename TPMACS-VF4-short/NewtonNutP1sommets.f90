SUBROUTINE NewtonNutP1sommets(A,Vold, V,U,Ue, ndim, choixf,  temps)
    !--------
    ! Modules
    !--------
    USE longr
    ...
    DO kiter = 1, kitermax
       ...
       DO i = 1, NbInc
          FF(i) = AireDsommet(i)* ( Xk(i)-Vold(i) )/dt - AireDsommet(i)*(Coef_prod*Ue(i) - nut_degra*Xk(i) &
          & -Coef_cons*U(i)*Xk(i) )
  ...
  END SUBROUTINE NewtonNutP1sommets